...
def main():
    parser = argparse.ArgumentParser(
        description="Pushes the contents "
        "of ForwardVision/forward_vision "
        "to the pi"
    )
    # parser.add_argument('source', required=True)
    parser.add_argument("destination", help="The host or ip of the pi to " "push to")
    ...
    source = os.path.abspath(os.path.join(os.path.dirname(__file__), "forward_vision"))
