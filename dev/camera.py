...
def main():
    ...
    """
    parser = argparse.ArgumentParser("Takes pictures using picamera or "
                                     "OpenCV VideoCapture")
    parser.add_argument('-o,', '--output', help="Output to directory",
                        default='/home/pi/ForwardVision/images/')
    parser.add_argument('-f,', '--format', help="Picture file name extension",
                        default='jpg')
